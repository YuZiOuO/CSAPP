...
unsigned floatScale2(unsigned uf) {
  ...
  if(_1 == 0){
    ...
    unsigned _2 = ((_0+1)&0xff);
    return (uf&(~(0xff<<23)))|(_2<<23);
  }
}
/* 
...
int floatFloat2Int(unsigned uf) {
  ...
  else if(expBiased<=23){
    frac = frac >> (23-expBiased);
  }
  else if(expBiased<=31){
    frac = frac << (expBiased-23);
  }
  else{
    return 0x80000000;
  }
